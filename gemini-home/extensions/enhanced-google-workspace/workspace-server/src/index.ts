...
async function main() {
  ...
  const contactsService = new ContactsService(authManager);
    ...
    'contacts.list',
    {
      ...
      inputSchema: {
        pageSize: z
          .number()
          .optional()
          .describe('The maximum number of contacts to return (default: 100).'),
      },
      ...readOnlyToolProps,
    },
    async (input) => {
      const result = await contactsService.listContacts(input.pageSize);
      return {
        content: [
          {
            type: 'text',
  ...
  server.registerTool(
    'contacts.search',
    {
      description: 'Searches the user\'s Google Contacts by name or email.',
      inputSchema: {
        query: z.string().describe('The search query (name or email).'),
      },
      ...readOnlyToolProps,
    },
    async (input) => {
      const result = await contactsService.searchContacts(input.query);
      return {
        content: [
          {
            type: 'text',
  ...
  server.registerTool(
    'contacts.update',
    {
      description: 'Updates a contact\'s information (e.g., notes/biography).',
      inputSchema: {
        resourceName: z.string().describe('The resource name of the contact (e.g., "people/c123").'),
        notes: z.string().describe('The notes or summary to register for this contact.'),
      },
    },
    async (input) => {
      const result = await contactsService.updateContact(input.resourceName, input.notes);
      return {
        content: [
          {
            type: 'text',
  ...
  server.registerTool(
    'contacts.create',
    {
      ...
      inputSchema: {
        ...
        familyName: z.string().optional().describe('The family name of the contact.'),
      },
    },
    async (input) => {
      const result = await contactsService.createContact(input.firstName, input.familyName);
      return {
        content: [
          {
            type: 'text',
    ...
    'tasks.list',
    {
      ...
      inputSchema: {
        tasklistId: z
          ...
          .optional()
          .describe(
            'The ID of the task list to list tasks from. Defaults to the default task list.',
          ),
        showCompleted: z
          .boolean()
          .optional()
          .describe('Whether to show completed tasks. Defaults to false.'),
        showDeleted: z
          .boolean()
          .optional()
          .describe('Whether to show deleted tasks. Defaults to false.'),
        showHidden: z
          .boolean()
          .optional()
          .describe('Whether to show hidden tasks. Defaults to false.'),
        dueMin: z
          .string()
          .optional()
          .describe(
    ...
    'tasks.create',
    {
      ...
      inputSchema: {
        tasklistId: z
          ...
          .optional()
          .describe(
            'The ID of the task list to create the task in. Defaults to the default task list.',
          ),
        ...
        due: z
          .string()
          .optional()
          .describe('The due date of the task (RFC 3339 timestamp).'),
        status: z
          .enum(['needsAction', 'completed'])
          .optional()
          .describe('The status of the task. Defaults to "needsAction".'),
      },
    },
    ...
    'tasks.update',
    {
      ...
      inputSchema: {
        ...
        tasklistId: z
          ...
          .optional()
          .describe(
            'The ID of the task list containing the task. Defaults to the default task list.',
          ),
        ...
        due: z
          .string()
          .optional()
          .describe('The new due date of the task (RFC 3339 timestamp).'),
        status: z
          .enum(['needsAction', 'completed'])
          .optional()
